...
function SignIn() {
  ...
  <CardHeader className="space-y-2">
    ...
    <CardDescription className="text-xl">
      Already have an account? <Link to='/login' className="text-[#EB5A3C]">Log in!</Link>
    </CardDescription>
  </CardHeader>
  <CardContent className="mt-4">
    <form className="space-y-6">
      <div className="space-y-2">
        <Label htmlFor="name" className="text-2xl text-[#EB5A3C]">Username</Label>
        <Input id="name" type="text" placeholder="[Your Name]" className="h-12 text-base border-black" />
      </div>
      <div className="space-y-2">
      ...
      <div className="space-y-2">
        <Label htmlFor="password" className="text-2xl text-[#EB5A3C]">Confirm Password</Label>
        <Input id="password" type="password" placeholder="*******" className="h-12 text-base border-black" />
      </div>
    </form>
  </CardContent>
